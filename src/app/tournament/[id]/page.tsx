...
export default function TournamentDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-[#001208] text-white pb-10">
            ...
            <div className="max-w-[1200px] mx-auto px-4 md:px-8">
                {/* Banner Section */}
                <div className="relative w-full aspect-[21/9] md:aspect-[4/1] rounded-[10px] overflow-hidden border-[2px] border-white shadow-2xl bg-[#050C0A]">
                    <Image
                    ...
                    <div className="flex border-b border-white/10">
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`relative px-8 py-4 text-[14px] md:text-[16px] font-bold transition-all duration-200 ${activeTab === tab
                                    ? 'bg-[#121E18] text-[#22C55E] rounded-t-xl'
                    ...
                    <div className="mt-8">
                        {activeTab === 'Overview' && (
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0">
                                ...
                                <div className="lg:col-span-2 space-y-8 lg:pr-16 pb-24">
                                    {/* Details Section */}
                                    <div>
                                                ...
                                                <div key={i} className="min-w-[280px] bg-[#05140C] rounded-2xl border border-white/10 overflow-hidden shrink-0">
                                                    ...
                                                    <div className="relative h-40">
                                                        ...
                                                        <div className="absolute top-2 left-2 flex items-center gap-2">
                                                            <div className="bg-[#1F2937]/90 backdrop-blur-sm px-2 py-0.5 rounded-md border border-white/10">
                                                                <span className="text-[10px] font-bold text-white uppercase tracking-wider">Registration Open</span>
                                                            </div>
                                                        </div>
                                                        <div className="absolute top-2 right-2 flex items-center gap-2">
                                                            <div className="bg-[#1F2937]/90 backdrop-blur-sm px-2 py-0.5 rounded-md border border-white/10 flex items-center gap-1.5">
                                                                <Users size={10} className="text-white" />
                                                                <span className="text-[11px] font-bold text-white">670/800</span>
                                                            </div>
                                                        </div>
                                                        {/* Overlay Logo */}
                                                    ...
                                                    <div className="p-4 pt-6 space-y-4">
                                                        ...
                                                        <div className="flex gap-1.5 overflow-x-auto no-scrollbar">
                                                            <span className="bg-[#052210] text-[#22C55E] text-[10px] font-bold px-2.5 py-1 rounded-md border border-[#22C55E]/20">BGMI</span>
                                                            <span className="bg-[#052210] text-[#22C55E] text-[10px] font-bold px-2.5 py-1 rounded-md border border-[#22C55E]/20">Solo</span>
                                                            <span className="bg-[#052210] text-[#22C55E] text-[10px] font-bold px-2.5 py-1 rounded-md border border-[#22C55E]/20">Entry-Free</span>
                                                        </div>
                        ...
                        {activeTab === 'Teams' && (
                            <div className="text-gray-300">
                                <p>Registered Teams content goes here...</p>
                            </div>
                        )}
                        {activeTab === 'Lobbies' && (
                            <div className="text-gray-300">
                                <p>Tournament Lobbies content goes here...</p>
                            </div>
                        )}
                        {activeTab === 'Rules' && (
                            <div className="text-gray-300">
            ...
            <div className="fixed bottom-0 left-0 md:left-64 right-0 border-t-[3px] border-white/20 py-2 md:py-2 px-4 md:px-8 bg-[#001208]/95 backdrop-blur-md z-40">
                <div className="max-w-[1200px] mx-auto flex justify-end">
                    <button className="bg-[#22C55E] text-white font-black text-[14px] md:text-[16px] px-10 md:px-14 py-2 md:py-2.5 rounded-xl hover:scale-105 active:scale-95 transition-all duration-200 uppercase tracking-wider shadow-[0_0_20px_rgba(34,197,94,0.3)]">
                        JOIN TOURNAMENT
                    </button>
                </div>
            </div>
